...
public interface AcademicAffairsPermissionService {
     ...
     */
    AcademicAffairsPermissionDTO getCurrentUserAcademicPermission(UserDO userDO);
     ...
     * @return 教务权限信息数据传输对象，如果用户没有教务权限则返回null
     */
    AcademicAffairsPermissionDTO getAcademicPermissionByUserUuid(String userUuid);
}
