...
public class TeacherController {
    ...
    public ResponseEntity<BaseResponse<TeacherDTO>> getTeacher(
        ...
        if (teacherUuid == null || teacherUuid.isBlank()) {
            throw new BusinessException("教师UUID不能为空", ErrorCode.PARAMETER_ERROR);
        }
        TeacherDTO teacherDTO=teacherService.getTeacher(teacherUuid);
    ...
    public ResponseEntity<BaseResponse<TeacherDisableDTO>> disableTeacher(
       ...
       TeacherDisableDTO teacherDisableDTO = teacherService.disableTeacher(teacherUuid, disable);
    ...
    public ResponseEntity<BaseResponse<Void>> updateTeacher(
        ...
        teacherService.updateTeacher(teacherUuid, teacherVO);
